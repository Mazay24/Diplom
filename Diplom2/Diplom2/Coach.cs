...
namespace Diplom2
{
    public partial class Coachcs : Form
    {
        DataBase dataBase = new DataBase();
        int id_club;
        public Coachcs(int id_club)
        {
            InitializeComponent();
            this.id_club = id_club;
            LoadDataFromDatabase(id_club);
        }
        ...
        public void LoadDataFromDatabase(int idClub)
        {
            ...
            while (reader.Read())
            {
                ...
                pictureBox.Size = new Size(200, 235);
        ...
        private void PictureBox_Click(object sender, EventArgs e)
        {
            ...
            if (reader.Read())
            {
                ...
                LookCoach look = new LookCoach(coachName, coachSurname, position, specialization, id, id_club);
                look.ShowDialog();
            }
