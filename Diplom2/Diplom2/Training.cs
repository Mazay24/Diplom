...
namespace Diplom2
{
    public partial class Training : Form
    {
        ...
        private void See()
        {
            ...
            SqlCommand trainingCommand = new SqlCommand("SELECT TOP (1000) [Id_training], [Название], [День_тренировки], SUBSTRING(CONVERT(varchar, [Начало], 114), 1, 5) as Начало, SUBSTRING(CONVERT(varchar, [Конец], 114), 1, 5) as Конец, [Места], [Занято], [Id_coach] FROM [Diplom].[dbo].[Training] WHERE [Id_club] = @ClubId ", dataBase.getConnection());
