namespace Шаблоны
{
    partial class Form5
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { Название, Column1, Column2, Column3, Column4 });
