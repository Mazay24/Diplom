    ...
    public partial class Coach : Form
    {
        ...
        public void LoadDataFromDatabase(int idClub)
        {
            ...
            while (reader.Read())
            {
                ...
                // Загружаем изображение из базы данных (предположим, что фотография хранится в столбце Фото)
        ...
        private void PictureBox_Click(object sender, EventArgs e)
        {
            ...
            // Выполняем действия по щелчку на PictureBox
            // Например, получаем данные тренера из базы данных по имени и фамилии
             // Получите фамилию тренера из PictureBox
            ...
            string query = "SELECT * FROM [Diplom].[dbo].[Coach] WHERE [Имя] = @Name AND [Фамилия] = @Surname";
                ...
                if (reader.Read())
                {
                    ...
                    // Продолжайте получать другие данные по необходимости

                    // Здесь вы можете использовать полученные данные для выполнения дальнейших действий
                    // Например, отобразить их в других элементах управления или выполнить другие операции
                }
        ...
        private void Label_Click(object sender, EventArgs e)
        {
            ...
            // Выполняем действия по щелчку на Label
            // Например, получаем данные тренера из Label
            // По умолчанию предполагаем, что данные на Label хранятся в определенном формате                
