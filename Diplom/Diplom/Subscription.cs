    ...
    public partial class Subscription : Form
    {
        ...
        private void DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                // Далее вы можете выполнить нужные действия с полученными данными
                // Например, вывести их в MessageBox:
                ...
                // Дальнейшая обработка переменной id
                // Например, вы можете её использовать в дальнейшей логике программы
            }
